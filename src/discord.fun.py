...
# some utils
from src import utils, cli, api

colorama.init()
utils.init()

icon = "https://github.com/BrightCat14/discord.fun/blob/v2/resources/icon.webp?raw=true"
                        ...
                        while True:
                            ...
                            if choice_page_4 == '1':
                                ...
                                if choice_raid == '1':
                                    ...
                                    api.change_server_name(guild_id, "discord.fun", token)
                                    IMAGE_URL = icon
                                    api.change_logo_guild(utils.get_picture_by_url(IMAGE_URL), token, guild_id)
                                    api.change_description("Nuked by discord.fun", token, guild_id)
                                    ...
                                    async def nuke(ctx):
                                        ...
                                        try:
                                            icon_bytes = await utils.fetch_image_bytes(icon)
