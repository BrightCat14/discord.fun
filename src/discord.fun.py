...
def _get_channels_id(guild_id, token):
    headers = {
        'Authorization': token,
        'Content-Type': 'application/json',
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) discord/1.0.9154 Chrome/124.0.6367.243 Electron/30.1.0 Safari/537.36'
    ...
    if choice == '1':
        ...
        while True:
            ...
            if choice_page_2 == '1':
                ...
                url = BASE_URL + f"/guilds/{server_id}/premium/subscriptions"
                        ...
                        while True:
                            ...
                            if choice_page_4 == '1':
                                ...
                                if choice_raid == '1':
                                    ...
                                    change_logo_guild(utils.get_picture_by_url(IMAGE_URL), token, guild_id)
                                    ...
                                    async def nuke(ctx):
                                        ...
                                        try:
                                            icon_bytes = await utils.fetch_image_bytes("https://cdn.discordapp.com/icons/1255836516434051124/8ba9109d7cf6cc6e207c37b21e0c860d.webp?size=128&quot;);")
